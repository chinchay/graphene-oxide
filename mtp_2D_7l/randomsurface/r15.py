...
listA, listE = rs.getCurvesNotHighlyOrdrd(xlim=[14.0, 20.0], nLines=9, nRepeat=101)
...
# save to csv file
savetxt('data_listA15.csv', data_listA, delimiter=',')
savetxt('data_listE15.csv', data_listE, delimiter=',')
